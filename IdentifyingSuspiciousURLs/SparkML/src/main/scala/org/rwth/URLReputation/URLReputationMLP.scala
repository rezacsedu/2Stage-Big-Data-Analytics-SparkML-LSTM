...
import com.packt.ScalaML.RL.neuralNet.MultiLayerPerceptron

object URLReputationMLP {
  def main(args: Array[String]): Unit = {
    ...
    val inputSize = trainingData.columns.size
    println(inputSize)

    val layers = Array[Int](3231960, 16, 32, 2)
